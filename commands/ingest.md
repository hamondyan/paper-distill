...
Manually ingest a specific paper using the `paper-distill:source-ingest` skill in `direct_identifier` mode.
...
The paper will be resolved, added to Zotero, written to `sources/`, and can then be compiled into the wiki.
