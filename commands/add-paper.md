...
This skips `inbox/`, lets the knowledge maintainer write approved source layers directly, performs Zotero handoff, and prepares the paper for wiki compilation.
