...
Search for academic papers, score them, bind the shortlist to arXiv, and stage detailed candidate cards in `inbox/`. Do not write directly to `raw/` from discovery.
...
3. Call `discover_papers(..., save_to_inbox=true)`
